...
- **CSE 309: Compiler**  
  Lexical, Syntax, Semantic Analysis, Intermediate Code Generation, Code Optimization  
...
- **CSE 405: Computer Security**  
  Cryptography, Application Security, Network Security, Security Attacks  
